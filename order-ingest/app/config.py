...
class Settings(BaseSettings):
    ...
    PROJECT_NAME: str = "FilaOps Order Ingest Service"
    VERSION: str = "0.1.0"
    ENVIRONMENT: str = "development"
    LOG_LEVEL: str = "INFO"

    INTERNAL_API_TOKEN: str = Field(
        default="change-me-order-ingest-token",
    ...
    def validate_production_token(self):
        if self.is_production and self.INTERNAL_API_TOKEN == "change-me-order-ingest-token":
